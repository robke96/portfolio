  ...
  return (
    <Card className='dark flex flex-col justify-center items-center w-full'>
        <div className='rounded-full border bg-neutral-950 text-card-foreground shadow-sm p-4 m-2'>
            <MessageCircleMoreIcon className='transition-all duration-300 hover:rotate-12 hover:scale-110' size={48} />
        </div>
        <CardTitle className='text-center'>
            <h3 className='font-bold whitespace-nowrap'>Let's Work Together</h3>
            <p className='text-sm text-neutral-400 whitespace-nowrap'>and make your ideas come to <span className='text-green-400'>reality</span></p>
        </CardTitle>
